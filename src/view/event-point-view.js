...
function createEventPointTemplate(eventPoint, offers, destination) {
  const {basePrice, type, dateFrom, dateTo, favorite} = eventPoint;
...
export default class EventPointView {
  ...
  getTemplate() {
    return createEventPointTemplate(this.eventPoint, this.offers, this.destination);
  }
